      ...
      <div className="p-6 sm:p-8">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold font-headline text-primary-container">
                {service.title}
              </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            {service.details.map((detail) => (
              <div key={detail.heading} className="bg-surface-container-low p-4 rounded-xl">
                <h3 className="font-headline font-bold text-primary-container text-sm mb-2">{detail.heading}</h3>
